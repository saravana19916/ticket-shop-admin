...
interface IProps {
  list: IPoliciesDetailsProps[];
}
const List: FC<IProps> = ({ list }) => {
  return (
    <>
      <TabPanel>
        <div className="row" id="myPoliciesList">
          {list?.map((l: IPoliciesDetailsProps, index) => (
            <>
              <ResponsiveTile key={(index + 1) * Math.random()}>
                ...
                >
                  <div className="position-absolute d-flex justify-content-between mx-4 my-4">
                    <WhiteBadge className="badge p-2">Policy</WhiteBadge>
                  </div>
                  ...
                  <Card.Body className="p-3 py-5">
                    <div className="d-flex justify-content-between">
                      <div className="col-9">
                        ...
                        <span className="fs-10px">{l.toBeVisibleOn}</span>
                      </div>
