                  ...
                  <Tab.Pane eventKey="all">
                    <Card>
                      <Card.Body>
                        ...
                        <Link to="#" className="text-primary">https://react.spruko.com/sash/preview/</Link>
                        ...
                        <div>
                          ...
                          <Link to="#"><i className="fa fa-star text-yellow fs-16"></i></Link>
                          <Link to="#"><i className="fa fa-star text-yellow fs-16"></i></Link>
                          <Link to="#"><i className="fa fa-star-o text-yellow fs-16 me-2"></i></Link>
                          <Link to="#" className="d-inline-block">(48) Reviews</Link>
                    ...
                    <Card>
                      <Card.Body>
                        ...
                        <div>
                          ...
                          <Link to="#"><i className="fa fa-star text-yellow fs-16"></i></Link>
                          <Link to="#"><i className="fa fa-star-o text-yellow fs-16 me-2"></i></Link>
                          <Link to="#" className="me-1 d-inline-block"> (48) Reviews</Link>
                          <Link to="#" className="fw-semibold">USD-$24</Link>
                        </div>
                      </Card.Body>
                    </Card>
                    ...
                    <Card>
                      <Card.Body>
                        ...
                        <div>
                          ...
                          <Link to="#"><i className="fa fa-star text-yellow fs-16"></i></Link>
                          <Link to="#"><i className="fa fa-star-o text-yellow fs-16 me-2"></i></Link>
                          <Link to="#" className="me-1 d-inline-block"> (18) Reviews</Link>
