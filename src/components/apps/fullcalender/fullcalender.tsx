...
class FullCalenderComponent extends Component {
  ...
  eventClick = (eventClick: { event: { title: string; start: string; remove: () => void; }; }) => {
    Alert.fire({
                  ...
                  <Col xl={3} className="animated fadeIn p-4 demo-app">
                    ...
                    <div className="mt-5">
                      ...
                      <Card className="border p-0 pt-3">
                        ...
                        <Card.Footer>
                          <div className="media media-xs overflow-visible">
                            <img className="avatar brround avatar-md me-3" src={Imagesdata("users12")} alt="avatar-img" />
                      ...
                      <Card className="border p-0 pt-3">
                        ...
                        <Card.Footer>
                          <div className="media media-xs overflow-visible">
                            <img className="avatar brround avatar-md me-3" src={Imagesdata("users16")} alt="avatar-img" />
                            <div className="media-body valign-middle">
