      ...
      <Col xl={6}>
        ...
        <Card>
          ...
          <Card.Body className="pb-3">
            ...
            <div className="mb-3">
              <Form.Control as="textarea" className=" is-valid" placeholder="is-valid"></Form.Control>
            </div>

            <div className="mb-3 is-loading">
              <Form.Control as="textarea" className="" placeholder="spinner-border spinner-border-sm"></Form.Control>
              <div className="spinner-border spinner-border-sm"></div>
            </div>

            <div className="mb-3 is-loading">
              <Form.Control as="textarea" className="" placeholder="disabled spinner-border spinner-border-sm" disabled ></Form.Control>
              <div className="spinner-border spinner-border-sm"></div>
            </div>

            <div className="mb-3 is-loading">
              <Form.Control as="textarea" className="" placeholder="readonly spinner-border spinner-border-sm" ></Form.Control>
              <div className="spinner-border spinner-border-sm"></div>
            </div>

            <div className="mb-3 is-loading">
              <Form.Control as="textarea" className=" is-valid" placeholder="is-valid spinner-border spinner-border-sm" ></Form.Control>
              <div className="spinner-border spinner-border-sm"></div>
            </div>
          </Card.Body>
        </Card>
        <Card>
          ...
          <Card.Body className="pb-3">
            <div className="mb-3 is-loading">
              <Form.Control as="textarea" className="" placeholder="spinner-border"></Form.Control>
              <div className="spinner-border"></div>
            </div>

            <div className="mb-3 is-loading">
              <Form.Control as="textarea" className="" placeholder="disabled spinner-border" disabled></Form.Control>
              <div className="spinner-border"></div>
            </div>

            <div className="mb-3 is-loading">
              <Form.Control as="textarea" className="" placeholder="readonly spinner-border" ></Form.Control>
              <div className="spinner-border"></div>
            </div>

            <div className="mb-3 is-loading">
              <Form.Control as="textarea" className=" is-valid" placeholder="is-valid spinner-border"></Form.Control>
              <div className="spinner-border"></div>
            </div>
          </Card.Body>
        </Card>
        ...
        <Card>
          ...
          <Card.Body className="pb-3">
            <div className="mb-3">
              <select className="form-control is-valid overflow-auto" multiple>
                <option>is-valid</option>
              </select>
            </div>

            <div className="mb-3 is-loading">
              <select className="form-control overflow-auto" multiple>
                <option>spinner-border spinner-border-sm</option>
              </select>
              <div className="spinner-border spinner-border-sm"></div>
            </div>
            ...
            <div className="mb-3 is-loading">
              <select className="form-control overflow-auto" multiple disabled>
                <option>disabled spinner-border spinner-border-sm</option>
              </select>
              <div className="spinner-border spinner-border-sm"></div>
            </div>
