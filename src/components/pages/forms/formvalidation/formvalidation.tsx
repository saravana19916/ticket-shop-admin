                ...
                <Form noValidate onSubmit={handleSubmit}>
                    ...
                    <Row className="mb-3">
                        <Form.Group as={Col} md="6" controlId="validationFormik103" className="position-relative">
                            ...
                            <Form.Control.Feedback type="invalid" tooltip>{errors.city as string}</Form.Control.Feedback>
                        </Form.Group>
                        <Form.Group as={Col} md="3" controlId="validationFormik104" className="position-relative ">
                            <Form.Label>State</Form.Label>
                           <Select classNamePrefix="Select" options={state} placeholder='State'/>

                            <Form.Control.Feedback type="invalid" tooltip> {errors.state as string}</Form.Control.Feedback>
                        </Form.Group>
                        <Form.Group as={Col} md="3" controlId="validationFormik105" className="position-relative">
                            ...
                            <Form.Control.Feedback type="invalid" tooltip>{errors.zip as string}</Form.Control.Feedback>
                        </Form.Group>
                    </Row>
                    <Button type="submit">Submit form</Button>
                </Form>
