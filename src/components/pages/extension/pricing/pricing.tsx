...
import { prices } from '../../../../commondata/commondata';
...
const Pricing: FC<PricingProps> = () => (
  <Fragment>
    ...
    <Row>
      ...
      {prices.map((price)=>(
      <Col sm={6} xl={3} md={6} lg={6} key={Math.random()}>
        <div className="panel price panel-color">
          <div className="ps-5 d-flex">
            <div>
              <h3 className={`pb-0 text-${price.color}`}>{price.heading}</h3>
              <p>per agent per month</p>
            </div>
            <div className="panel-body ms-auto">
              <p className="lead py-0"><strong>${price.text} </strong>/ month</p>
            </div>
          </div>
          <ListGroup variant="flush" className="pb-5">
            <ListGroup.Item className="border-0"><i className={`mdi mdi-checkbox-marked-circle-outline text-${price.color} p-2 fs-16`}></i><strong> {price.data} Free</strong> Domain Name</ListGroup.Item>
            <ListGroup.Item className="border-0"><i className={`mdi mdi-checkbox-marked-circle-outline text-${price.color} p-2 fs-16`}></i><strong>{price.data1} </strong> One-Click Apps</ListGroup.Item>
            <ListGroup.Item className="border-0"><i className={`mdi mdi-checkbox-marked-circle-outline text-${price.color} p-2 fs-16`}></i><strong> {price.data2} </strong> Databases</ListGroup.Item>
            <ListGroup.Item className="border-0"><i className={`mdi mdi-checkbox-marked-circle-outline text-${price.color} p-2 fs-16`}></i><strong> Money </strong> BackGuarantee</ListGroup.Item>
            <ListGroup.Item className="border-bottom-0"><i className={`mdi mdi-checkbox-marked-circle-outline text-${price.color} p-2 fs-16`}></i><strong> 24/7</strong> support</ListGroup.Item>
          </ListGroup>
          <div className="panel-footer text-center px-5 border-0 pb-5 br-7">
            <Button variant={price.color} className="btn-block btn-pill">Purchase Now!</Button>
          </div>
        </div>
      </Col>
      ))}
