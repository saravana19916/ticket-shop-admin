...
const Profile: FC<ProfileProps> = () => {
  const [userProfileDetails, setUserProfileDetails] = useState<any>(undefined);
  const [userName, setUserName] = useState<any>(undefined);
  useEffect(() => {
    const profileDetails = localStorage.getItem("user");
    if (profileDetails) {
      setUserProfileDetails(JSON.parse(profileDetails));
      const userName = `${
        JSON.parse(profileDetails).user?.profile?.first_name || ""
      } ${JSON.parse(profileDetails).user?.profile?.last_name || ""}`;
                        ...
                        <div className="panel profile-cover">
                          ...
                          <div className="profile-cover__img">
                            <div className="profile-img-1">
                              <img src={Imagesdata("users21")} alt="user21" />
                            </div>
                            <div className="profile-img-content text-dark text-start">
                              <div className="text-dark">
                                <h3 className="h3 mb-2">{userName}</h3>
                        ...
                        <div className="">
                          <div className="social social-profile-buttons mt-5 float-end">
                            <div className="mt-3">
                              ...
                              <Link
                                to="https://www.youtube.com/@tixboxofficial"
                                className="social-icon text-primary me-2"
                                target="_blank"
                              >
                              ...
                              <Link
                                to="https://www.linkedin.com/company/tixbox/"
                                className="social-icon text-primary me-2"
                                target="_blank"
                              >
                              ...
                              <Link
                                to="https://www.google.com/account/about/?hl=en-US"
                                className="social-icon text-primary me-2"
                                target="_blank"
                              >
                  ...
                  <Card.Body>
                    ...
                    <div className="d-flex align-items-center mb-3 mt-3">
                      <div className="me-4 text-center text-primary">
                        <span>
                          <i className="fe fe-calendar fs-20"></i>
                        </span>
                      </div>
                      <div>
                        <strong>
                          {moment(
                            userProfileDetails?.user?.profile?.birth_date
                          ).format("MMMM Do, YYYY")}
                        </strong>
                      </div>
                    </div>
                    <div className="d-flex align-items-center mb-3 mt-3">
                      ...
                      <div>
                        <strong>
                          {userProfileDetails?.user?.profile?.country?.name}
                        </strong>
                      </div>
                    </div>
                    <div className="d-flex align-items-center mb-3 mt-3">
                      ...
                      <div>
                        <strong>
                          {userProfileDetails?.user?.profile?.phone_number}
                        </strong>
                      </div>
                    </div>
                    <div className="d-flex align-items-center mb-3 mt-3">
                      ...
                      <div>
                        <strong>{userProfileDetails?.user?.email}</strong>
                      </div>
                    </div>
                  </Card.Body>
                </Card>
                <Card>
                  ...
                  <Card.Body>
                    <div className="tags">
                      ...
                      <span className="tag">Codiegniter</span>
