...
import { navigations } from '../../../commondata/commondata';
...
`}
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Nav variant="pills" defaultActiveKey="videos" className='navicon'>
                <Nav.Item>
...
`}
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Nav variant="pills" className="nav-pills-circle" defaultActiveKey="play">
                <Nav.Item>
...
`}
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Nav className={`nav1 bg-${navigation.color} mt-4 br-7`} defaultActiveKey={`${navigation.color}-Active`} key={Math.random()}>
                <Nav.Item className="nav-item1">
                  <Nav.Link eventKey={`${navigation.color}-Active`} className="text-white" active>Active</Nav.Link>
                </Nav.Item>
                <Nav.Item className="nav-item1">
                  <Nav.Link eventKey={`${navigation.color}-Link-1`} className="text-white">Link</Nav.Link>
                </Nav.Item>
                <Nav.Item className="nav-item1">
                  <Nav.Link eventKey={`${navigation.color}-Link-2`} className="text-white">Link</Nav.Link>
                </Nav.Item>
                <Nav.Item className="nav-item1">
                  <Nav.Link eventKey={`${navigation.color}-Disable`} className="text-white-50" disabled>Disabled</Nav.Link>
                </Nav.Item>
              </Nav>
              ))}
