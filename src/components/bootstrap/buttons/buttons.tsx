...
import { Button, ButtonGroup, Card, Col, Dropdown, Row, Form, Collapse, ToggleButtonGroup, ToggleButton } from 'react-bootstrap';
import { Link } from 'react-router-dom';
import PageHeader from '../../../layouts/layoutcomponents/pageheader';
import { Buttonicons, defaultbuttons, iconButtons, socialbuttons, socialbuttons1, socialbuttons2 } from '../../../commondata/commondata';
      ...
      <Col md={12} xl={6}>
        <Card>
          <Card.Header className='d-sm-flex justify-content-between align-items-center d-block'>
            <Card.Title className='mb-3 mb-sm-0'>Default Button</Card.Title>
            ...
            <div className="text-wrap">
              ...
              <div className="example">
                <div className="btn-list">
                  {defaultbuttons.map((defaultbutton) => (
                  <Link key={Math.random()} to="#" className={`btn btn-${defaultbutton.color}`}>{defaultbutton.class}</Link>
                  ))}
          ...
          <Card.Body>
            <div className="text-wrap">
              ...
              <div className="example">
                <div className="btn-list">
                {defaultbuttons.map((defaultbutton) => (
                  <Link key={Math.random()} to="#" className={`btn btn-${defaultbutton.color} disabled`}>{defaultbutton.class}</Link>
                  ))}
          ...
          <Card.Body>
            <div className="text-wrap">
              ...
              <div className="example">
                <div className="btn-list">
                {defaultbuttons.map((defaultbutton) => (
                  <Link key={Math.random()} to="#" className={`btn btn-${defaultbutton.color} btn-pill`}>{defaultbutton.class}</Link>
                  ))}
                </div>
              </div>
            </div>
...
`}
      ...
      <Col md={12} xl={6}>
        <Card>
          <Card.Header className='d-sm-flex justify-content-between align-items-center d-block'>
            <Card.Title className='mb-3 mb-sm-0'>Outline Button</Card.Title>
            <Form className="ms-auto">
          ...
          <Card.Body>
            <div className="text-wrap">
              ...
              <div className="example">
                <div className="btn-list">
                {defaultbuttons.map((defaultbutton) => (
                  <Link key={Math.random()} to="#" className={`btn btn-outline-${defaultbutton.color} disabled`}>{defaultbutton.class}</Link>
                  ))}
                </div>
              </div>
            </div>
          ...
          <Card.Body>
            <div className="text-wrap">
              ...
              <div className="example">
                <div className="btn-list">
                {defaultbuttons.map((defaultbutton) => (
                  <Link key={Math.random()} to="#" className={`btn btn-${defaultbutton.color}-light `}>{defaultbutton.class}</Link>
                  ))}
                </div>
              </div>
            </div>
            ...
            <div className="text-wrap">
              ...
              <div className="example">
                <div className="btn-list btn-list-icon">
                  ...
                  <Button key={Math.random()} variant={Buttonicon.color}><i className={`${Buttonicon.icon} me-2`}></i>{Buttonicon.class}</Button>
                  ))}
                </div>
              </div>
            </div>
            ...
            <div className="text-wrap">
              ...
              <div className="example">
                <div className="btn-list">
                  ...
                  <Button key={Math.random()} className="btn-icon" variant={iconButton.color}><i className={iconButton.icon}></i></Button>
                  ))}
                </div>
              </div>
            </div>
...
`}
      ...
      <Col md={12} xl={6}>
        <Card>
          <Card.Header className='d-sm-flex justify-content-between align-items-center d-block'>
            <Card.Title className='mb-3 mb-sm-0'>Social buttons</Card.Title>
            <Form className="ms-auto">
            ...
            <div className="text-wrap">
              ...
              <div className="example">
                <div className="btn-list">
                  ...
                  <Button key={Math.random()} className="btn-icon" variant={socialbutton.color}><i className={socialbutton.icon}></i></Button>
                  ))}
                </div>
              </div>
            </div>
...
`}
      ...
      <Col md={12} xl={6}>
        <Card>
          <Card.Header className='d-sm-flex justify-content-between align-items-center d-block'>
            <Card.Title className='mb-3 mb-sm-0'>Toggle buttons</Card.Title>
            <Form className="ms-auto">
...
`}
    ...
    <Row>
      <Col md={12} xl={6}>
        <Card>
          <Card.Header className='d-sm-flex justify-content-between align-items-center d-block'>
            <Card.Title className='mb-3 mb-sm-0'>Color variations</Card.Title>
            <Form className="ms-auto">
          ...
          <Card.Body>
            <div className="text-wrap">
              ...
              <div className="example">
                <div className="btn-list">
                  {socialbuttons1.map((socialbutton1)=>(
                  <Link key={Math.random()} to="#" className={`btn btn-${socialbutton1.color}`}>{socialbutton1.class}</Link>
                  ))}
                </div>
              </div>
            </div>
        ...
        <Card>
          ...
          <Card.Body>
            <div className="text-wrap">
              ...
              <div className="example">
                <div className="btn-list">
                  {socialbuttons2.map((socialbutton2)=>(
                  <Button key={Math.random()} variant={socialbutton2.color}><i className={`${socialbutton2.icon} me-2`}></i>{socialbutton2.color}</Button>
                  ))}
                </div>
              </div>
            </div>
...
`}
    ...
    <Row>
      <Col md={12} xl={6}>
        <Card>
          <Card.Header className='d-sm-flex justify-content-between align-items-center d-block'>
            <Card.Title className='mb-3 mb-sm-0'>Loading button</Card.Title>
            <Form className="ms-auto">
...
`}
      ...
      <Col md={12} xl={6}>
        <Card>
          <Card.Header className='d-sm-flex justify-content-between align-items-center d-block'>
            <Card.Title className='mb-3 mb-sm-0'>Button Toolbar</Card.Title>
            <Form className="ms-auto">
...
`}
    ...
    <Row>
      <Col md={12} xl={6}>
        <Card>
          <Card.Header className='d-sm-flex justify-content-between align-items-center d-block'>
            <Card.Title className='mb-3 mb-sm-0'>Checkbox Button Group</Card.Title>
            <Form className="ms-auto">
