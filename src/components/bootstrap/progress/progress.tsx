        ...
        <Card>
          ...
          <Card.Body>
            <div className="example">
              ...
              <ProgressBar variant="primary" className="mb-3" now={10} />

              <ProgressBar variant="primary" className="mb-3" now={20} />

              <ProgressBar variant="primary" className="mb-3" now={40} />

              <ProgressBar variant="primary" className="mb-3 " now={60} />

              <ProgressBar variant="primary" className="mb-3 " now={80} />
            </div>
