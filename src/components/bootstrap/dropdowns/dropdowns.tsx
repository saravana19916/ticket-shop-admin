...
import { dropdowns } from '../../../commondata/commondata';
            ...
            <Card.Body>
              <div className="text-wrap">
                ...
                <div className="example">
                  <ButtonGroup className="mt-2 mb-2 me-1 flex-wrap">
                  {dropdowns.map((dropdown) => (
											<Dropdown className='me-1' key={Math.random()}>
												<Dropdown.Toggle variant={dropdown.color}
            ...
            <Card.Body>
              <div className="text-wrap">
                ...
                <div className="example">
                  ...
                  {dropdowns.map((dropdown) => (
											<Dropdown className='me-1' key={Math.random()}>
												<Dropdown.Toggle variant={`outline-${dropdown.color}`}
													data-bs-toggle="dropdown">
													Action<span className="no-caret"></span>
												</Dropdown.Toggle>
												<Dropdown.Menu role="menu" as="ul">
												<li className="dropdown-plus-title">Dropdown <b className="fa fa-angle-up" aria-hidden="true"></b></li>
													<Dropdown.Item as="li">Action</Dropdown.Item>
													<Dropdown.Item as="li">Another Action</Dropdown.Item>
													<Dropdown.Item as="li">Something Else Here</Dropdown.Item>
													<Dropdown.Divider/>
            ...
            <Card.Body>
              <div className="text-wrap">
                ...
                <div className="example">
                  ...
                  {dropdowns.map((dropdown) => (
											<Dropdown className='me-1' key={Math.random()}>
												<Dropdown.Toggle variant={`${dropdown.color}-light`}
													data-bs-toggle="dropdown">
													Action<span className="no-caret"></span>
												</Dropdown.Toggle>
												<Dropdown.Menu role="menu" as="ul">
            ...
            <Card.Body>
              <div className="text-wrap">
                ...
                <div className="example">
                  ...
                  {dropdowns.map((dropdown) => (
											<Dropdown className='me-1' key={Math.random()}>
												<Dropdown.Toggle className='btn-pill' variant={`${dropdown.color}-light`}
													data-bs-toggle="dropdown">
													Action<span className="no-caret"></span>
												</Dropdown.Toggle>
												<Dropdown.Menu role="menu" as="ul">
            ...
            <Card.Body>
              <div className="text-wrap">
                ...
                <div className="example">
                  ...
                  {dropdowns.map((dropdown) => (
											<Dropdown className='me-1' key={Math.random()}>
												<Dropdown.Toggle variant={dropdown.color} className='btn-pill'
													data-bs-toggle="dropdown">
													Action<span className="no-caret"></span>
												</Dropdown.Toggle>
												<Dropdown.Menu role="menu" as="ul">
