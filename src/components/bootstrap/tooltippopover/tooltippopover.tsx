...
interface StaticTooltipDatas {
  id:string
  variant:string
  classname:string
  placement:string
}
const StaticTooltipData:StaticTooltipDatas[] = [
  {
    id: "1",
    variant: "primary",
...
interface ColoredTooltipDatas {
  id:string
  variant:string
  popoverclass:string
  placement:string
  popheaderclass:string
  classname:string
}
const ColoredTooltipData:ColoredTooltipDatas[] = [
  {
    id: "1",
    variant: "primary",
...
interface popoverDatas {
  id:string
  variant:string
  placement:string
}
const popoverData:popoverDatas[] = [
  {
    id: "1",
    variant: "primary",
