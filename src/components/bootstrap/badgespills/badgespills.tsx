...
import { Buttonbadges, badgepills, badges2} from '../../../commondata/commondata';
        ...
        <Card>
          ...
          <Card.Body>
            ...
            <div className="example">
              {badges2.map((badge2) => (
              <Badge className='me-2' key={Math.random()} bg={badge2.color}>{badge2.color}</Badge> 
              ))}
      ...
      <Col md={12} lg={6}>
        <Card>
          ...
          <Card.Body>
            ...
            <div className="example">
              {badgepills.map((badgepill)=>(
              <Badge className='me-2' key={Math.random()} pill bg={badgepill.color}>{badgepill.color}</Badge> 
              ))}
            </div>
        ...
        <Card>
          ...
          <Card.Body>
            ...
            <div className="example2">
                 {Buttonbadges.map((Buttonbadge) => (
              <Button key={Math.random()} className="mt-1  mb-1 me-3" variant={Buttonbadge.color}>Notifications<Badge bg="white" className={`text-${Buttonbadge.color} ms-2`}>2</Badge></Button>
              ))}
            </div>
      ...
      <Col xl={12}>
        <Card>
          ...
          <Card.Body>
            ...
            <div className="example">
            {Buttonbadges.map((Buttonbadge) => (
              <Button key={Math.random()} variant={Buttonbadge.color} className="position-relative me-5 mb-3"> Projects
        ...
        <Card>
          ...
          <Card.Body>
            ...
            <div className="example">
              ...
              <h1>Heading 01<Badge bg="default ms-1">New</Badge></h1>
              <h2>Heading 01<Badge bg="default ms-1">New</Badge></h2>
              <h3>Heading 01<Badge bg="default ms-1">New</Badge></h3>
              <h4>Heading 01<Badge bg="default ms-1">New</Badge></h4>
              <h5>Heading 01<Badge bg="default ms-1">New</Badge></h5>
              <h6>Heading 01<Badge bg="default ms-1">New</Badge></h6>
            </div>
        ...
        <Card>
          ...
          <Card.Body>
            ...
            <div className="example">
              ...
              <h1 className="text-primary" >Heading 01<Badge bg="primary ms-1">New</Badge></h1>
              <h2 className="text-red" >Heading 01<Badge bg="danger ms-1">New</Badge></h2>
              <h3 className="text-yellow" >Heading 01<Badge bg="warning ms-1">New</Badge></h3>
              <h4 className="text-green" >Heading 01<Badge bg="success ms-1">New</Badge></h4>
              <h5 className="text-info" >Heading 01<Badge bg="info ms-1">New</Badge></h5>
              <h6 className="text-secondary" >Heading 01<Badge bg="secondary ms-1">New</Badge></h6>
