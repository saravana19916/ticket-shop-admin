...
import DropDowns from "../../bootstrap/dropdowns/dropdowns";
      ...
      <div className="e-table px-5 pb-5 table-responsive">
        <div className="d-block mb-5">
          ...
          <div className="d-flex align-items-center gap-4">
            ...
            <Dropdown>
              <Dropdown.Toggle className="btn-pill" variant="light">
                <i className="fa fa-ellipsis-v" aria-hidden="true"></i>
              </Dropdown.Toggle>
              <Dropdown.Menu>
                <Dropdown.Item eventKey="1">All Invoice</Dropdown.Item>
                <Dropdown.Item eventKey="2">Paid Invoice</Dropdown.Item>
                <Dropdown.Item eventKey="3">Pending Invoice</Dropdown.Item>
                <Dropdown.Item eventKey="3">Overdue Invoice</Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
          </div>
        </div>
              ...
              <tr {...headerGroup.getHeaderGroupProps()}>
                {headerGroup.headers.map((column: any) => (
                  <th
                    ...
                    className={`${column.className} fw-bold`}
                  >
