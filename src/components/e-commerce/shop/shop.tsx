                ...
                <Card.Body>
                  <div className="">
                    ...
                    <div className="d-flex overflow-visible">
                      <img className="avatar bradius avatar-xl me-4 p-2 bg-white border" src={Imagesdata("png4")} alt="avatar-img" />
                    ...
                    <div className="d-flex overflow-visible mt-5">
                      <img className="avatar bradius avatar-xl me-4 p-2 bg-white border" src={Imagesdata("product13")} alt="avatar-img" />
                      <div className="media-body valign-middle">
                    ...
                    <div className="d-flex overflow-visible mt-5">
                      <img className="avatar bradius avatar-xl me-4 p-2 bg-white border" src={Imagesdata("png1")} alt="avatar-img" />
                      <div className="media-body valign-middle">
                    ...
                    <div className="d-flex overflow-visible mt-5">
                      <img className="avatar bradius avatar-xl me-4 p-2 bg-white border" src={Imagesdata("png3")} alt="avatar-img" />
                      <div className="media-body valign-middle">
                ...
                <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                  ...
                  <Card.Body className="p-4 bg-white br-7">
                    <Row>
                      ...
                      <Col xl={3} lg={12}>
                        <Link to={`${import.meta.env.BASE_URL}ecommerce/addproduct/`} className="btn btn-primary btn-block float-end my-2"><i className="fa fa-plus-square me-2"></i>New Product</Link>
                      </Col>
                    </Row>
                  </Card.Body>
                              ...
                              <Card>
                                <div className="product-grid6">
                                  <div className="product-image6 p-5">
                                    <ul className="icons">
                                      <li>
                                        <Link to={`${import.meta.env.BASE_URL}ecommerce/productdetails/`} className="btn btn-primary"> <i className="fe fe-eye">  </i> </Link>
                                      </li>
                                      <li><Link to={`${import.meta.env.BASE_URL}ecommerce/addproduct/`} className="btn btn-success"><i className="fe fe-edit"></i></Link></li>
                                  ...
                                  <Card.Body className="pt-0">
                                    <div className="product-content text-center">
                                      <h1 className="title fw-bold fs-20"><Link to={`${import.meta.env.BASE_URL}ecommerce/productdetails/`}>{idx.heading}</Link></h1>
                                  ...
                                  <Card.Footer className="text-center">
                                    <Link to={`${import.meta.env.BASE_URL}ecommerce/shoppingcart/`} className="btn me-1 btn-primary mb-1" onClick={() => { AddToCart(idx.id) }}><i className="fe fe-shopping-cart mx-2" ></i>Add to cart</Link>
                                    <Link to={`${import.meta.env.BASE_URL}ecommerce/wishlist/`} className="btn me-1 btn-outline-primary mb-1"><i className="fe fe-heart mx-2 wishlist-icon"></i>Add to wishlist</Link>
                                  </Card.Footer>
                                </div>
                              </Card>
                            </Col>
                                  ...
                                  <Row className="g-0">
                                    ...
                                    <Col xl={3} lg={12} md={12}>
                                      <div className="product-list">
                                        <div className="product-image">
                                          <ul className="icons">
                                            <li><Link to={`${import.meta.env.BASE_URL}ecommerce/productdetails/`} className="btn btn-primary"><i className="fe fe-eye text-white "></i></Link></li>
                                            <li><Link to={`${import.meta.env.BASE_URL}ecommerce/addproduct/`} className="btn btn-success"><i className="fe fe-edit text-white "></i></Link></li>
                                            <li><Link to={`${import.meta.env.BASE_URL}ecommerce/wishlist/`} className="btn btn-danger"><i className="fe fe-x text-white"></i></Link></li>
                                          </ul>
                                        </div>
                                        <div className="br-be-0 br-te-0">
                                          <Link to={`${import.meta.env.BASE_URL}ecommerce/productdetails/`} className="">
                                    ...
                                    <Col xl={3} lg={12} md={12} className="my-auto">
                                      <Card.Body className="p-0">
                                        ...
                                        <Link to={`${import.meta.env.BASE_URL}ecommerce/shoppingcart/`} className="btn me-2 btn-primary btn-block" onClick={() => { AddToCart(idx.id) }}><i className="fe fe-shopping-cart mx-2"></i>Add to cart</Link>
                                        <Link to={`${import.meta.env.BASE_URL}ecommerce/wishlist/`} className="btn me-2 btn-outline-primary btn-block mt-2"><i className="fe fe-heart mx-2 wishlist-icon"></i>Add to wishlist</Link>
                                      </Card.Body>
                                    </Col>
                                  </Row>
                                </Card.Body>
