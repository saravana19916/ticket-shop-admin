...
import { Button, Card, Col, Container, Nav, Row, Tab, Accordion, Badge, FormControl, InputGroup, Navbar } from 'react-bootstrap';
import { Link } from "react-router-dom";
import { Imagesdata } from '../../commondata/commonimages';
import { data1 } from '../../commondata/commondata';
...
const LandingPage: FC<LandingPageProps> = () => {
    ...
    const Navbar1 = () => {
        ...
        pageLink.forEach((Element:any) => {
            Element.addEventListener("click", (event:any) => {
                event.preventDefault();
                const hrefdata: any = Element?.getAttribute("href");
                const elementview: any = document.querySelector(hrefdata);
            ...
            <div className="page-main">
              ...
              <div className="responsive-navbar p-0">
                ...
                <div className="header-nav-right p-5">
                                            <Link to={`${import.meta.env.BASE_URL}authentication/register/`} className="btn ripple btn-min w-sm btn-outline-primary me-2">New User
                                            </Link>
                                            <Link to={`${import.meta.env.BASE_URL}authentication/login/`} className="btn ripple btn-min w-sm btn-primary me-2">Login
                                            </Link>
                                        </div>
                </Navbar.Collapse>
              </div>
                            ...
                            <Container>
                                <Row>
                                    <Navbar className="main-sidemenu navbar px-0 justify-content-between">
                                        <Link className="navbar-brand ps-0 d-none d-lg-block" to={`${import.meta.env.BASE_URL}dashboard`}>
                                            <img alt="logo-3" className="logo-2" src={Imagesdata("logodark")} />
                                            <img src={Imagesdata("logo")} className="logo-3" alt="logo" />
                                        </Link>
                                        <Navbar1/>
                                        <div className="header-nav-right d-lg-flex d-none">
                                            <Link to={`${import.meta.env.BASE_URL}authentication/register/`} className="btn ripple btn-min w-sm btn-outline-primary me-2 my-auto d-lg-none d-xl-block d-block" target="_blank">New User
                                            </Link>
                                            <Link to={`${import.meta.env.BASE_URL}authentication/login/`} className="btn ripple btn-min w-sm btn-primary me-2 my-auto d-lg-none d-xl-block d-block" target="_blank">Login
                                            </Link>
                                        </div>
                    ...
                    <div className="demo-screen-headline main-demo main-demo-1 spacing-top overflow-hidden" id="home" onClick={() => SidSwitcherIcons()}>
                        <Container className="px-sm-0">
                            <Row>
                                ...
                                <Col xl={6} lg={6} className="my-auto"><img src={Imagesdata("marcket4")} alt="" /></Col>
                            </Row>
                        </Container>
                    </div>
                </div>
                                                ...
                                                <Col lg={6} md={12}>
                                                    <Card className="features main-features main-features-9 wow fadeInUp" data-wow-delay="0.1s">
                                                        ...
                                                        <div className="text-left">
                                                            ...
                                                            <p className="mb-0">
                                                                We included nine (9) types of the best possible chart options for your project. You can customize with your Imagesdatament.
                                                            </p>
                                                        </div>
                                                    </Card>
                                                </Col>
                                                            ...
                                                            <div className='row'>
                                                                ...
                                                                <Col xl={6} lg={6} className="ps-0">
                                                                    <div className="text-center mb-3" >
                                                                        <img src={Imagesdata("business")} alt="" className="br-5" />
                                                                    </div>
                                                                </Col>
                                            ...
                                            <section className="sptb demo-screen-demo" id="faqs">
                                                <Row className="align-items-center">
                                                    ...
                                                    <Col md={12} lg={6} className="">
                                                        <img src={Imagesdata("frequently")} alt="" />
                                                    </Col>
                                                </Row>
                                            </section>
                                        </Row>
                                        ...
                                        <Row>
                                                ...
                                                <Card className="bg-transparent">
                                                    <Card.Body className="px-1">
                                                        <div className="d-flex overflow-visible">
                                                            <img className="card-aside-column br-5 cover-image" alt='media-12' src={Imagesdata("media12")} />
                                            ...
                                            <Col lg={6}>
                                                <Card className="bg-transparent">
                                                    <Card.Body className="px-1">
                                                        <div className="d-flex overflow-visible">
                                                            <img className="card-aside-column br-5 cover-image" alt='media-22' src={Imagesdata("media22")} />

                                                            <div className="ps-3 flex-column">
                                                                <Badge bg="danger" className="me-1 mb-1 mt-1">Lifestyle</Badge>
                                                                <h3><Link to={`${import.meta.env.BASE_URL}pages/extension/blogdetails/`}>Generator on the Internet..</Link></h3>
                                                                <div className="">Excepteur sint occaecat cupidatat non proident, accusantium sunt in culpa qui officia deserunt mollit anim id est laborum....</div>
                                                            </div>
                                                        </div>
                                                    </Card.Body>
                                            ...
                                            <Col lg={6}>
                                                <Card className="bg-transparent">
                                                    <Card.Body className="px-1">
                                                        <div className="d-flex overflow-visible">
                                                            <img className="card-aside-column br-5 cover-image" alt='about' src={Imagesdata("media28")} />
                                            ...
                                            <Col lg={6}>
                                                <Card className="bg-transparent">
                                                    <Card.Body className="px-1">
                                                        <div className="d-flex overflow-visible">
                                                            <img className="card-aside-column br-5 cover-image" alt='media-25' src={Imagesdata("media25")} />
                                            ...
                                            <div className="text-center mt-5">
                                                <Link to={`${import.meta.env.BASE_URL}pages/extension/blogs`} className="btn btn-outline-primary pt-2 pb-2" target="_blank"><i className="fe fe-arrow-right mx-2"></i>Discover More</Link>
  ...
  <Row>
    <Col xl={8} md={12} className="d-block mx-auto">
      <div className="testimonia">
        ...
        <h3 className="title mb-0">Elizabeth</h3>
        <span className="post">Web Developer</span>

        <div className='rating-stars'>
            <Link to="#" className="lh-1"><i className="fa fa-star text-yellow fs-16"></i></Link>
            <Link to="#" className="lh-1"><i className="fa fa-star text-yellow fs-16"></i></Link>
            <Link to="#" className="lh-1"><i className="fa fa-star text-yellow fs-16"></i></Link>
            <Link to="#" className="lh-1"><i className="fa fa-star text-yellow fs-16"></i></Link>
            <Link to="#" className="lh-1"><i className="fa fa-star-o text-yellow fs-16 me-2"></i></Link>
        </div>
                         
        <div className='owl-controls clickable'>
        <div className="owl-pagination">
        <div className="owl-page active me-2">
            <span className=""></span>
        </div>
        <div className="owl-page me-2">
            <span className=""></span>
        </div>
    ...
    <div className="col-xl-8 col-md-12 d-block mx-auto">
      <div className="testimonia">
        ...
        <div className="testimonia-data">
          <h3 className="title mb-0">williamson</h3>
          <span className="post">Web Developer</span>
          <div className="rating-stars">
                ...
                <Link to="#"><i className="fa fa-star text-yellow fs-16"></i></Link>
                <Link to="#"><i className="fa fa-star text-yellow fs-16"></i></Link>
                <Link to="#"><i className="fa fa-star text-yellow fs-16 me-2"></i></Link>
  ...
  <div className="row">
    <div className="col-xl-8 col-md-12 d-block mx-auto">
      <div className="testimonia">
        ...
        <div className="testimonia-data">
          <h3 className="title mb-0">Sophie Carr</h3>
          <span className="post">Web Developer</span>
          <div className="rating-stars">
            <Link to="#"><i className="fa fa-star text-yellow fs-16"></i></Link>
            <Link to="#"><i className="fa fa-star text-yellow fs-16"></i></Link>
                                    ...
                                    <Row>
                                        ...
                                        <Col lg={2} sm={6} md={4} className="">
                                            ...
                                            <ul className="list-unstyled mb-5 mb-lg-0">
                                                <li><Link to={`${import.meta.env.BASE_URL}dashboard/`}>Dashboard</Link></li>
                                                <li><Link to={`${import.meta.env.BASE_URL}bootstrap/bootstrapalerts/`}>Elements</Link></li>
                                                <li><Link to={`${import.meta.env.BASE_URL}pages/forms/formelements/`}>Forms</Link></li>
                                                <li><Link to={`${import.meta.env.BASE_URL}charts/chartjs/`}>Charts</Link></li>
                                                <li><Link to={`${import.meta.env.BASE_URL}pages/tables/datatables/`}>Tables</Link></li>
                                                <li><Link to={`${import.meta.env.BASE_URL}filemanager/fileattachments/`}>Other Pages</Link></li>
                                            </ul>
                                        </Col>
                                        <Col lg={2} sm={6} md={4} className="">
                                            <h6>Information</h6>
                                            <ul className="list-unstyled mb-5 mb-lg-0">
                                                <li><Link to={`${import.meta.env.BASE_URL}pages/extension/aboutcompany/`}>Our Team</Link></li>
                                                <li><Link to={`${import.meta.env.BASE_URL}pages/extension/aboutcompany/`}>Contact US</Link></li>
                                                <li><Link to={`${import.meta.env.BASE_URL}pages/extension/aboutcompany/`}>About</Link></li>
                                                <li><Link to={`${import.meta.env.BASE_URL}pages/extension/services/`}>Services</Link></li>
                                                <li><Link to={`${import.meta.env.BASE_URL}pages/extension/blogs/`}>Blog</Link></li>
                                                <li><Link to={`${import.meta.env.BASE_URL}pages/extension/term/`}>Terms and Services</Link></li>
                                            </ul>
                                        </Col>
                                        <Col lg={4} sm={12} md={4} className="">
                                            <div className="">
                                                <Link to={`${import.meta.env.BASE_URL}dashboard`}><img loading="lazy" alt="" className="logo mb-3" src="../assets/images/brand/logo-3.png" /></Link>
