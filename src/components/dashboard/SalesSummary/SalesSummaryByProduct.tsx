...
import { salesSummaryDemo } from "../../../commondata/dashboarddata";
...
const SalesSummaryByProduct: FC<ISalesSummaryByProductProps> = ({
  ...
  const [dataDemo, setDataDemo] = useState<ISalesSummary[]>();
  useEffect(() => {
    ...
    <>
      <div className="col-12 ">
        <Card style={{ boxShadow: "0 4px 8px rgba(0, 0, 0, 0.2)" }}>
          ...
          <Card.Body className="d-flex flex-column p-6 justify-content-center">
                ...
                <div className="row pt-lg-5 px-lg-6 pt-0 px-0 pt-xl-5 px-xl-6">
                  <div className="col-12 table-responsive">
                    <table className="table table-borderless text-nowrap">
                      ...
                      <tbody className="border-0">
                        {dataDemo?.map((l: ISalesSummary, index) => (
                          <>
                            <tr
                              className="border-bottom"
                              key={index + 1 * Math.random() * 100}
