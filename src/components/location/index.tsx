...
const index = () => {
  ...
  const getItemsPerRow = () => {
    const rows = document.querySelectorAll("#myLocationList > *");
    const rowWidth =
      document.querySelector("#myLocationList")?.clientWidth || 0;
    let totalWidth = 0;
    let count = 0;
      ...
      <LandingPageWrapper>
        <div className="row" style={{ maxWidth }}>
          <div className="col-6 mb-3">
            <p className="fw-600 fs-26px text-black mb-3">My Location</p>
          </div>
          <div className="col-6 mb-3">
            <Link
              to="/add-location"
