...
export function localStorageBackUp() {
    ...
    if (localStorage.getItem("sashhorizontalhover")) {
        HorizontalHoverMenu();
    }
    if (localStorage.getItem("sashhorizontal")) {
        Horizontal();
    }
...
export const horizontalmenusticky = () => {
    if (document.querySelector("body-sidebar") && !document.body.classList.contains("landing-page")) {
        if (window.scrollY > 30) {
            document.querySelector("body-sidebar")?.classList.add("fixed-header");
            let Scolls = document.querySelectorAll(".sticky");
            Scolls.forEach((e) => {
                e?.classList.add("stickyClass");
            });
        } else {
            document.querySelector("body-sidebar")?.classList.remove("fixed-header");
            let Scolls = document.querySelectorAll(".sticky");
            Scolls.forEach((e) => {
